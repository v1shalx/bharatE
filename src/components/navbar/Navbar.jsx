...
function Navbar() {
  ...
  const isAdmin = user?.user?.email === 'mahajanxvishal@gmail.com';
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>BharatE</h1>
                  </div>
                </Link>
              </div>
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
                    <img
                      ...
                      src="https://avatars.githubusercontent.com/u/141364555?v=4"
                      alt="vishal_mahajan" />
                  </a>
                </div>
